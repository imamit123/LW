<?php
// $Id: page.tpl.php,v 1.2 2010/10/25 17:06:29 chevy Exp $
...
<?php print render($page['header']); ?>
  ...
  <div id="post-script-wrapper">
    ...
    <?php endif; ?>
    <div class="clearfix" style="text-align: center; font-size: 0.8em"><?php print t('Design by ') . l('Rapid Doodle Designs', 'http://www.rapiddoodle.ca'); ?></div>
