...
jQuery("document").ready(function() {
   var divHeight = jQuery('.page-user #block-views-parent-profile-detail-block .views-field-mail').height();
  // alert(divHeight);
   jQuery('.page-user #block-views-parent-profile-detail-block .views-field-field-mobile-no').css('min-height', divHeight+'px');
});
