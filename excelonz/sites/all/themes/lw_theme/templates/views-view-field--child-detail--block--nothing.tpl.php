...
//$city ="City";
//print "<div class=user-span><span>City</span><span class=field-content>".$output ."</span></div>";
print "<div class=user-class><span>Class</span><span class=field-content>".$class ."</span></div>";
//print "<div class=user-section><span>Section</span><span class=field-content>".$section ."</span></div>";
