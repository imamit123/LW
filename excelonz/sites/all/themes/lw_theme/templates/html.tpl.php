...
$title1 = '';
$title2 = '';
$title1 = strtolower($head_title_array[title]);
...
<body class="<?php print $title2.' '.$classes; ?>"<?php print $attributes; ?>>
  <div id="skip-link">
...
<script type="text/javascript">
 ...
 (function() {
   ...
   uv.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'widget.uservoice.com/VMEKK7eqLfaLcyBE1sJOw.js';
